...
## Creation Date: Wed Jun  4 17:19:36 PDT 2014
## Last Modified: Wed Jun  4 17:19:39 PDT 2014
## Filename:      Makefile
## Syntax:        GNU/BSD makefile
##
## Description:   Makefile for basic processing Humdrum data files 
##                for the Well-Tempered Clavier, Books I & II by J.S. Bach.
##
...
#           git clone https://github.com/humdrum-tools/bach-wtc
#
...
kernscores: humdrum-extras-check
	mkdir -p kernscores; (cd kernscores && humsplit h://wtc)
	@echo "[0;32m"
...
ifeq ($(shell which curl),)
	...
	for file in kern/*.krn; do \
	   ...
	   curl \
	      "http://kern.humdrum.org/data?l=wtc&file=$$TBASE.krn&format=pdf" \
...
ifeq ($(wildcard .git),)
	...
	@echo "***    [0;32mgit clone https://github.com/humdrum-tools/bach-wtc[0;31m"
	@echo "[0m"
	exit 1
endif
